...
function NativeStackNavigator(props) {
  ...
  _react.default.useEffect(() => navigation.addListener && navigation.addListener('tabPress', e => {
  ...
  return _react.default.createElement(_NativeStackView.default, _extends({}, rest, {
    state: state,
