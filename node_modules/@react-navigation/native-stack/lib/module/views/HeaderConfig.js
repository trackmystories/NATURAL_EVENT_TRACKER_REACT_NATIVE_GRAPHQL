...
import { ScreenStackHeaderConfig, ScreenStackHeaderRightView // eslint-disable-next-line import/no-unresolved
...
export default function HeaderConfig(props) {
  ...
  return React.createElement(ScreenStackHeaderConfig, {
    ...
    color: headerTintColor !== undefined ? headerTintColor : colors.primary // Keep this temporarily for compatibility with old versions of screens
    // @ts-ignore
    ,
  ...
  }, headerRight !== undefined ? React.createElement(ScreenStackHeaderRightView, null, headerRight()) : null);
}
